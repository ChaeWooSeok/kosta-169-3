	...
	line-height: 100%;
				...
				<div class="fee_tab_sub">
					...
					<div class="marry_fee1">
						<h3 class="txt-type1">결제 완료</h3>
						<h3 class="txt-title">결제가 완료되었습니다.</h3>
						<h3 class="txt-backmain">메인화면으로 돌아가기</h3>
						<!-- <span
						...
						</span> <span class="fee-type1"> <span class="txt-type1">클래식
						...
						</span> <span class="fee-type2"> <span class="txt-type1">노블레스
						...
						<span class="txt-type1">클래식 B 서비스 1,200,000원 (vat 별도)</span>
					<span class="box">
						<span class="cell">
					...
					<span class="box">
					 ...
					 <!--  <div class="purchase">
						...
						<span class="fee-type1"> <span class="txt-type1">결제서비스아이콘 자리</span> 
						
						<span class="box"> -->
							<!--  <span class="cell">
								<ul>
									<li><label>상품명</label> <input type='text' readonly /></li><br/><br/>
									<li><label>할인율 </label> <input type='text' readonly /></li><br/><br/>
									<li><label>결제방식</label> <select name="method">
											<option value="cash">무통장 입금</option>
											<option value="card">현금결제</option>
									</select></li><br/><br/>
									<li><label>기간 </label> <input type='text' readonly /></li><br/><br/>
									<li><label>금액</label> <input type='text' readonly /></li>
								</ul>
							</span> -->
