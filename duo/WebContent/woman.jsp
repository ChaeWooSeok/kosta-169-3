...
function next_step()
{
	...
	case 0:
		...
		else
		{
			...
			$(".box-type1").eq(0).removeClass("m_type" + (now_step + 1));

			now_step = now_step + 1;
			$(".box-type1").eq(0).addClass("m_type" + (now_step + 1));
    ...
    <div id="matching">
		...
		<div class="box-type2">
			...
			<form name="msForm" method="post" action="duo/?cmd=search ">	
				<input type="hidden" name="u_ident2" value="2" />
					...
					<tr>
						<td height="55" colspan="9">
							<table width="1120" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td>&nbsp;</td>
									<td width="182" height="55"><label for="u_age1" title="24세 이하" class="age_rd">20세~24세<input type="checkbox" class="u_age" id="u_age1" name="age" value="980101" /></label></td>
									<td width="10">&nbsp;</td>
						...
						<td height="55" colspan="9">
							<table width="1120" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="10">&nbsp;</td>
									<td width="182"><label for="u_age8" title="56세 이상" class="age_rd">56세 이상<input type="checkbox" class="u_age" id="u_age8"  name="age" value="630101"/></label></td>
									<td>&nbsp;</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td height="55" colspan="9">
							<table width="1120" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td>&nbsp;</td>
									<td width="182" height="55"><label for="u_height1" title="157cm 이하" class="height_rd">153~157cm 이하<input type="checkbox" class="u_height" id="u_height1" name="height" value="153" /></label></td>
									<td width="10">&nbsp;</td>
					...
					<td height="55" colspan="9">
							<table width="1120" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="10">&nbsp;</td>
									<td width="182"><label for="u_height7" title="183cm 이상" class="height_rd">183cm 이상<input type="checkbox" class="u_height" id="u_height7" name="height" value="183"/></label></td>
									<td>&nbsp;</td>
								</tr>
							</table>
						</td>
						...
						<td height="55" colspan="9">
							<table width="1120" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="10">&nbsp;</td>
									<td width="190"><label for="u_job4" title="교사,강사,공무원,공사" class="job_rd">교사,강사,공무원,공사<input type="checkbox" class="u_job" id="u_job4" name="job" value="교사,공무원,강사,공사" /></label></td>
									<td>&nbsp;</td>
								</tr>
							</table>
						</td>
				...
				<table width="1120" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="55" colspan="9">
							<table width="300" cellspacing="0" cellpadding="0" class='sel2'>
								<tr>
									<td width="80" height="55" ><a href="detail_w.jsp" onclick="window.open(this.href,'','left margin=500 top margin=200 width=460, height=400, scrollbars=yes'); return false;" href="detail_m.jsp"><input type='image' src="img/bin.jpg" style="width:80px; height:55px;"/></a></td>
								<!-- 	<td width="10">&nbsp;</td> -->
									<td width="190" height="55" ><a href="detail_w.jsp" onclick="window.open(this.href,'','left margin=500 top margin=200 width=460, height=400, scrollbars=yes'); return false;" href="detail_m.jsp"><label>원빈</label></a></td>
									<!-- <td width="10">&nbsp;</td> -->
									<td width="190" height="55" ><a href="detail_w.jsp" onclick="window.open(this.href,'','left margin=500 top margin=200 width=460, height=400, scrollbars=yes'); return false;" href="detail_m.jsp"><label>38세</label></a></td>
									<td>&nbsp;</td>
